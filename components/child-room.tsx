...
import type { AnswerInput, DictationRoom, SubmittedAnswer } from "@/lib/types";
      ...
      <div className="answer-grid">
        {current.targetFields.includes("partOfSpeech") ? (
          <label>
            ...
            <input
              autoComplete="off"
              value={answer.partOfSpeech ?? ""}
              onChange={(event) => setAnswer((value) => ({ ...value, partOfSpeech: event.target.value }))}
            />
          </label>
        ) : null}
        ...
        {current.targetFields.includes("meaning") ? (
          <label>
            ...
            <input
              ...
              onChange={(event) => setAnswer((value) => ({ ...value, meaning: event.target.value }))}
            />
          </label>
        ) : null}
      </div>
